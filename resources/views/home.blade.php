<x-app-layout>
    ...
    <header class="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden bg-primary dark:bg-background-dark">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 text-white/90 text-sm font-medium mb-8 border border-white/10 backdrop-blur-sm">
            ...
            <p class="text-lg md:text-xl text-white/70 mb-10 max-w-2xl mx-auto font-light leading-relaxed">
                Akses ribuan buku fisik tanpa harus membeli. Hemat biaya, hemat ruang, dan mulai petualangan membaca Anda hari ini.
            </p>
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a class="bg-secondary-accent text-primary-dark font-bold text-lg px-8 py-4 rounded-xl shadow-xl shadow-secondary-accent/20 hover:scale-105 transition-transform flex items-center gap-2" href="{{ route('catalog.index') }}">
                    Jelajahi Katalog
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap justify-center gap-4 md:gap-8">
                ...
                <a class="group flex items-center gap-3 pl-2 pr-6 py-2 rounded-full hover:bg-background-light dark:hover:bg-white/5 border border-transparent hover:border-gray-200 dark:hover:border-white/10 transition-all" href="{{ route('catalog.index', ['category' => $category->id]) }}">
                    <div class="w-10 h-10 rounded-full bg-primary/10 dark:bg-primary/20 text-primary flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-xs text-gray-500">{{ $category->books_count ?? $category->books()->count() }} Buku</p>
                    </div>
                </a>
                @endforeach
            </div>
    ...
    <section class="py-24 relative overflow-hidden bg-background-light dark:bg-background-dark">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {{-- Main Feature Card --}}
                <div class="group relative col-span-1 md:col-span-2 lg:col-span-2 lg:row-span-2 bg-primary rounded-[2.5rem] p-8 lg:p-12 overflow-hidden shadow-soft">
                    ...
                    <div class="relative z-10 h-full flex flex-col justify-between">
                        <div>
                            ...
                            <h3 class="text-3xl lg:text-4xl font-bold text-white mb-6 leading-tight">Koleksi Lengkap & Berkualitas</h3>
                            <p class="text-white/80 text-lg leading-relaxed max-w-sm">
                                Ribuan judul dari berbagai genre tersedia. Mulai dari fiksi populer, bisnis, hingga pengembangan diri.
                            </p>
                        </div>
                        <div class="mt-8">
                ...
                {{-- Small Feature Cards --}}
                <div class="col-span-1 bg-white dark:bg-surface-dark border border-orange-100 dark:border-white/5 rounded-[2.5rem] p-8 flex flex-col justify-center relative overflow-hidden group">
                ...
                <div class="col-span-1 bg-white dark:bg-surface-dark border border-green-100 dark:border-white/5 rounded-[2.5rem] p-8 flex flex-col justify-center relative overflow-hidden group">
                    <div class="relative z-10">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Pesan lewat web, ambil atau antar. Tanpa ribet.</p>
                    </div>
                </div>
                
                <div class="col-span-1 md:col-span-2 lg:col-span-2 bg-white dark:bg-surface-dark border border-gray-100 dark:border-white/5 rounded-[2.5rem] p-8 flex items-center relative overflow-hidden shadow-soft group">
                    <div class="relative z-10 flex flex-col sm:flex-row items-start sm:items-center gap-6 w-full">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Perpanjangan Mudah</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400 max-w-md">
                                Belum selesai baca? Perpanjang masa sewa dengan satu klik dari dashboard Anda.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section id="cara-sewa" class="py-24 bg-surface-light dark:bg-surface-dark border-t border-gray-100 dark:border-white/5 relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-6 text-center">
                @php
                $steps = [
                    ['icon' => 'how_to_reg', 'title' => 'Daftar Akun', 'desc' => 'Buat akun gratis dalam hitungan detik.'],
                    ['icon' => 'menu_book', 'title' => 'Pilih Buku', 'desc' => 'Jelajahi katalog dan pilih buku favorit.'],
                    ['icon' => 'payments', 'title' => 'Bayar Sewa', 'desc' => 'Checkout aman dengan Transfer/QRIS.'],
                    ['icon' => 'local_library', 'title' => 'Ambil Buku', 'desc' => 'Ambil di lokasi atau request antar.'],
                ];
                @endphp
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                <div>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-5 p-4 rounded-2xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group cursor-pointer">
                            <div class="w-14 h-14 rounded-2xl bg-primary text-white flex items-center justify-center shrink-0 shadow-lg shadow-primary/20">
