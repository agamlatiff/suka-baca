...
<head>
    ...
    <title>Sukabaca - Daftar Akun</title>
...
<body class="bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark transition-colors duration-300 font-sans min-h-screen flex">
    ...
    <div class="hidden lg:flex w-1/2 bg-primary relative overflow-hidden flex-col justify-between p-12 xl:p-20">
        ...
        <div class="relative z-10">
            ...
            <p class="text-lg text-white/80 max-w-lg leading-relaxed font-light">
                Daftarkan diri Anda hari ini dan akses koleksi buku terbaik kami.
            </p>
        </div>
        ...
        <div class="relative z-10 mt-12">
            <div class="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-6 max-w-md shadow-2xl">
                ...
                <p class="text-white text-sm italic mb-4">"Akhirnya menemukan tempat peminjaman buku yang modern dan lengkap!"</p>
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-full bg-gradient-to-tr from-secondary-accent to-orange-400 flex items-center justify-center text-primary font-bold text-sm">RB</div>
                    <div>
                        <p class="text-white text-sm font-bold">Raka Budi</p>
                        <p class="text-white/60 text-xs">Mahasiswa Sastra</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="w-full lg:w-1/2 flex flex-col items-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto bg-grid-pattern">
        {{-- Mobile Header --}}
        <div class="lg:hidden w-full flex items-center justify-between mb-8">
        ...
        <button class="hidden lg:block absolute top-8 right-8 p-2 rounded-full hover:bg-gray-100 dark:hover:bg-white/5 transition-colors text-gray-500 dark:text-gray-400" 
            onclick="document.documentElement.classList.toggle('dark'); localStorage.setItem('darkMode', document.documentElement.classList.contains('dark'))">
            <span class="material-symbols-rounded block dark:hidden">dark_mode</span>
            <span class="material-symbols-rounded hidden dark:block">light_mode</span>
        </button>
        
        <div class="w-full max-w-md space-y-6 mt-4 lg:mt-8">
            <div class="text-center lg:text-left">
                <h2 class="text-3xl md:text-4xl font-extrabold text-primary dark:text-white mb-3">Buat Akun Baru</h2>
                <p class="text-gray-500 dark:text-gray-400">Lengkapi data diri di bawah ini untuk bergabung.</p>
            </div>
            ...
            <div class="bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800 rounded-xl p-4 flex items-start gap-3">
                ...
                <div>
                    <h3 class="text-sm font-bold text-red-800 dark:text-red-300">Pendaftaran Gagal</h3>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                {{-- Name --}}
                <div>
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1.5" for="name">Nama Lengkap</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                            <span class="material-symbols-rounded text-gray-400 group-focus-within:text-primary transition-colors">person</span>
                        </div>
                ...
                {{-- Phone --}}
                <div>
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1.5" for="phone">No. Handphone</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                            <span class="material-symbols-rounded text-gray-400 group-focus-within:text-primary transition-colors">call</span>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1.5" for="password">Password</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
